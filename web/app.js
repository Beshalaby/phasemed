...
function renderCapabilities() {
  ...
  // The rail keeps one line; the full checklist lives in the capability sheet.
  const ready = keys.filter((key) => capabilities[key] === "available").length;
  $("capabilitySummary").textContent = state.model ? `${ready} of ${keys.length} capabilities active` : "Capabilities";
}
